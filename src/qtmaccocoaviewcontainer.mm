...
/*!
    \fn QtMacCocoaViewContainer::QtMacCocoaViewContainer(void *cocoaViewToWrap, QWidget *parent)
    ...
    with C++ source.
*/
QtMacCocoaViewContainer::QtMacCocoaViewContainer(void *cocoaViewToWrap, QWidget *parent)
   : QWidget(parent, 0)
{
...
*/
void *QtMacCocoaViewContainer::cocoaView() const
{
    return d->nsview;
}
...
*/
void QtMacCocoaViewContainer::setCocoaView(void *cocoaViewToWrap)
{
    ...
    // Wet the new view as the content view for the window.
