...
static QPlatformNativeInterface::NativeResourceForIntegrationFunction resolvePlatformFunction(const QByteArray &functionName)
{
    ...
    return nativeInterface->nativeResourceFunctionForIntegration(functionName);
}
...
/*!
  \class QtMacPasteboardMime
  \brief The QtMacPasteboardMime class converts between a MIME type and a
  ...
  QtMacPasteboardMime's role is to bridge the gap between MIME and UTI;
  ...
  A subclass of QtMacPasteboardMime will automatically be registered, and active, upon instantiation.
  ...
  When working with MIME data, Qt will interate through all instances of QtMacPasteboardMime to
...
/*! \enum QtMacPasteboardMime::QtMacPasteboardMimeType
    \internal
*/
...
*/
QtMacPasteboardMime::QtMacPasteboardMime(char t) : type(t)
{
    QPlatformNativeInterface::NativeResourceForIntegrationFunction function = resolvePlatformFunction("addToMimeList");
    typedef void (*AddToGlobalMimeListFunction)(QtMacPasteboardMime *);
...
*/
int QtMacPasteboardMime::count(QMimeData *mimeData)
{
    Q_UNUSED(mimeData);
    return 1;
}
...
/*!
  \fn QString QtMacPasteboardMime::convertorName()
...
/*!
  \fn bool QtMacPasteboardMime::canConvert(const QString &mime, QString flav)
...
/*!
  \fn QString QtMacPasteboardMime::mimeFor(QString flav)
...
/*!
  \fn QString QtMacPasteboardMime::flavorFor(const QString &mime)
...
/*!
    \fn QVariant QtMacPasteboardMime::convertToMime(const QString &mime, QList<QByteArray> data, QString flav)
...
/*!
  \fn QList<QByteArray> QtMacPasteboardMime::convertFromMime(const QString &mime, QVariant data, QString flav)
